function sendMoney(){
 ...
 document.addEventListener("DOMContentLoaded", function() {
   // Adding click event listener to the "View customer" button
...
function openTransactionHistory() {
   window.location.href = 'customer.html#transactionHistory';
}
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   $('#transactionHistory').on('show.bs.modal', function(event) {
       // Your logic to add transactions to the modal, same as before
   });
});
